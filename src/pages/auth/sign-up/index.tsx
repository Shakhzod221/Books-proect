  ...
  return (
    <div className="flex items-center h-screen w-full">
      ...
      <div className="flex-1 h-full w-[50%] flex items-center justify-center">
        ...
        <h1 className="text-[36px] font-bold mb-[10px] select-none">Registratsiya</h1>
        <p className="p-0 text-[14px] font-normal mb-[20px]">
          Akkauntingiz bormi? <Link className="text-[#549FF9] underline" to={"/sign-in"}>
            Akkauntga kirish
            </Link>
          </p>
      <Form 
